...
%type <A5.exptype> type_parser /* Returns type */
%%
/*
...
sub_expression:
    ...
    |sub_expression PLUS mult_expression { Plus($1,$3) }
    | mult_expression                    {$1} 
...
function_call:
    | function_call LP or_expression RP {App($1,$3)}
    | function_abstraction {$1}

function_abstraction:
    | definition {$1}
    | REC ID ID COLON type_parser EQ definition  {(RecLambda($3,$2,$5,$7))} 
    | BACKSLASH ID COLON type_parser DOT definition {(Lambda($2,$4,$6))} 
;
